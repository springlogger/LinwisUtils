    ...
    >
        <div class="m-1 h-full flex flex-col justify-between">
            <div>
                ...
                <div
                    @click="testUser"
                    class="mt-5 cursor-pointer bg-gray-50 rounded-2xl p-2 text-black text-center hover:bg-gray-200"
                >
                    <i class="fa-solid fa-user"></i>
                    {{ isMouseOverSideBar === true ? 'Profile' : '' }}
                </div>
            </div>
            ...
            <button
                ...
                :class="{
                    'p-1 cursor-pointer hover:bg-white hover:text-black':
            ...
            >
                ...
                {{ user.isUserAuthorized ? (isMouseOverSideBar === true ? 'Log out ' : '') : '' }}
            </button>
        </div>
    </div>
</template>
